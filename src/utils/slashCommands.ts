...
export const SLASH_COMMANDS: SlashCommandDef[] = [
  ...
  { name: "skill", usage: "/skill <名称|install|uninstall>", descZh: "运行/安装/卸载技能", descEn: "Run/install/uninstall skill" },
  ...
  { name: "fleet", usage: "/fleet", descZh: "Fleet 多 Worker 编排", descEn: "Fleet multi-worker runs" },
  { name: "vim", usage: "/vim [on|off]", descZh: "Composer Vim 模式", descEn: "Composer Vim mode" },
